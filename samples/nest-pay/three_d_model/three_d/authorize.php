...
$model->setSuccessUrl('http://www.payconn.com/samples/nest-pay/three_d_model/three_d/complete.php');
$model->setFailureUrl('http://www.payconn.com/samples/nest-pay/three_d_model/three_d/complete.php');
