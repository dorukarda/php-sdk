...
$model->setSuccessUrl('http://www.payconn.com/samples/nest-pay/three_d_model/three_d_pay/complete.php');
$model->setFailureUrl('http://www.payconn.com/samples/nest-pay/three_d_model/three_d_pay/complete.php');
